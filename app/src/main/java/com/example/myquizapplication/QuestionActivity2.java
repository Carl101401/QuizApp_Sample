...
public class QuestionActivity2 extends AppCompatActivity {
    ...
    private static final long LOGOUT_DELAY = 60000; // 60 seconds
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            if (list.size() > 0) {
                                ...
                                Intent students2Intent = new Intent(QuestionActivity2.this, Students2.class);
                                startActivity(students2Intent);
                            }
                        } else {
                            Toast.makeText(QuestionActivity2.this, "Question Not Exist", Toast.LENGTH_SHORT).show();
                            Intent students2Intent = new Intent(QuestionActivity2.this, Students2.class);
    ...
    protected void onPause() {
        super.onPause();
        // Stop the logout timer when the activity loses focus (e.g., when the home button is clicked)
        stopLogoutTimer();
    }
    ...
    protected void onResume() {
        super.onResume();
        // Start the logout timer when the activity regains focus (e.g., when returning to the app)
        startLogoutTimer();
    }
    ...
    private void startLogoutTimer() {
        ...
        logoutTimer = new CountDownTimer(LOGOUT_DELAY, 1000) {
            @Override
